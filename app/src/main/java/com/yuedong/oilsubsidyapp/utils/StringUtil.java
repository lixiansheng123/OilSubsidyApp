...
public final class StringUtil {
	...
	public static boolean isChinese(CharSequence str) {
		if (com.yuedong.oilsubsidyapp.utils.StringUtil.isEmpty(str)) {
			return false;
		}
	...
	public static String getSerialNumber() {
		return DateUtil.getCurrent(DateUtil.FORMAT_YYYYMMDDHHMMSS) + getRandomNumbers(5);
	}
	...
	public static String PennyToDollor(String penny) {
		...
		return df.format((com.yuedong.oilsubsidyapp.utils.StringUtil.getDouble(penny)) / 100);
	}
	...
	public static String formatDoubleDot(String str) {
		DecimalFormat df = new DecimalFormat("0.00");
		return df.format((com.yuedong.oilsubsidyapp.utils.StringUtil.getDouble(str)));
	}
}
